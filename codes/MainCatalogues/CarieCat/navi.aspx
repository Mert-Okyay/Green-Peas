...
<head><meta http-equiv="X-UA-Compatible" content="chrome=1, IE=edge" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" /><title>
	SDSS DR12 Navigate Tool
</title><link href="../../tools.css" rel="stylesheet" type="text/css" />
    <style>
    ...
    <script type="text/javascript">var wsGetJpegurl = "http://skyserver.sdss.org/dr12/SkyserverWS/ImgCutout/getjpeg?TaskName=Skyserver.Chart.Navi&";</script>
    <script type="text/javascript">var wsGetImage64 = "http://skyserver.sdss.org/dr12/SkyserverWS/ImgCutout/getImage64?TaskName=Skyserver.Chart.Navi&";</script>
 ...
 <script type="text/javascript">
     function keystone_login(logout) {
         if (logout) {
             ...
             //window.location.href = "http://apps.sciserver.org/login-portal/Account/Login?callbackUrl=http://skyserver.sdss.org/dr12/en/tools/chart/navi.aspx?ra=195.546461671409&dec=-0.0879159691195055&scale=0.2";
             window.location.href = "http://apps.sciserver.org/login-portal/Account/Login?callbackUrl=http://skyserver.sdss.org%2fdr12%2fen%2ftools%2fchart%2fnavi.aspx";
...
<!--        <asp:Div id="sc1s3rv3r_uname" class="headerAlert">-->
    ...
    <form method="post" action="./navi.aspx?ra=195.546461671409&amp;dec=-0.0879159691195055&amp;scale=0.2" id="form1">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="MNjJTtkNsjnOs4aVyABkWB6NAW9FlZ1a9R/miVIBqPsbjuhkCk/1wEQPc8DJ9py69qe0x8hdx+UZ9iCZqiRGkAhBK4M6zLM/IVpgBnffZlI=" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="8D35AC65" />
    <div>
	    ...
	    <tr>
		    ...
		    <td class='title' align="left" width="140">&nbsp;&nbsp;DR12</td>
	    </tr>
        </table>
        <table border="0" cellspacing="0" cellpadding="0" >
	        <tr>
                ...
                <td class='s' align="left" ONMOUSEOVER="this.T_WIDTH='140';return escape('Help on the current tool')"><a target="MosaicWindow" href="naviinfo.aspx">Help&nbsp;|</a></td>
        
                <td class='s' align="left" ONMOUSEOVER="this.T_WIDTH='140';return escape('View the tool tutorial (Flash)')"><a target="MosaicWindow" href="navi.swf">Tutorial&nbsp;|</a></td>
...
<table width="160" bgColor="lightblue" border="1" cellspacing=1 cellpadding=1 valign="middle">
    ...
    <tr>
	<td><span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Name of object to be resolved.')">name</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value=' ' name='objid' id='objid' onChange='setobj();' ></td><td>&nbsp;<span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Name of object to be resolved.')"><input type='button' value='Resolve' id='resolve' name='resolve'  >			</span></td></tr></table>
		</td>
</tr>
<tr>
	<td><span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS. Value is wrapped around the sphere.')">ra</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value='195.546461671409' name='ra' id='ra' onChange='setra();' ></td><td>&nbsp;<span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS. Value is wrapped around the sphere.')">deg			</span></td></tr></table>
		</td>
</tr>
<tr>
	<td><span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Declination as decimal degrees or DD:MM:SS. Value is wrapped around the sphere.')">dec</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value='-0.0879159691195055' name='dec' id='dec' onChange='setdec();' ></td><td>&nbsp;<span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Declination as decimal degrees or DD:MM:SS. Value is wrapped around the sphere.')">deg			</span></td></tr></table>
		</td>
</tr>
<tr>
...
<input type="hidden" value="0.2" name="scale" id="scale">
